...
@Component({
  selector: 'app-csupprimer',
  templateUrl: './csupprimer.component.html',
  styleUrls: ['./csupprimer.component.scss']
})
export class CsupprimerComponent {
  ...
  DialogElement(isSubCategory: boolean = false) {
    const categoryType = isSubCategory ? 'sous' : '';
    const message = `cette ${categoryType} catégorie `;
  ...
  template: `
    <div class="mdc-dialog__container">
        <div class="mat-mdc-dialog-surface mdc-dialog__surface">
            ...
            <div class="p-x-24 p-b-24 ng-star-inserted">
                Êtes-vous sûr de vouloir supprimer <span class="f-w-600">{{ message }}</span>?
            </div>
...
export class DialogAnimationsElementComponent {
  constructor(public dialogRef: MatDialogRef<DialogAnimationsElementComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { }

  get message(): string {
    return this.data && this.data.message ? this.data.message : '';
  }
  closeDialog(): void {
